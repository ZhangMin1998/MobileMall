<template>
  <div class="wrapDiv">
    <input type="text" v-model="name" @blur="nameBlurFn" class="goodsEntry" placeholder="输入名称" />
    <input type="text" v-model="price" @blur="priceBlurFn" class="goodsEntry" placeholder="输入价格" />
    <input
      type="text"
      v-model="describe"
      @blur="describeBlurFn"
      ...
      placeholder="输入描述"
    />
    <input type="text" v-model="img" @blur="imgBlurFn" class="goodsEntry" placeholder="输入图片" />
  </div>
</template>
